...
In the [Dependency Dashboard](https://github.com/straub/renovate-repro-replacement-peerdeps/issues/2), the update remains under "The following updates are pending. To force the creation of a PR, click on a checkbox below.", but checking that box still does not create a PR.
